...
来源：Codex 任务 `01a0d370-06c7-7c83-8812-926a57b8f80b`「WS-06 六列输入与 tag 通路」，由协调任务 `01a0cfac-3176-7590-bf34-c0f176a45118` 派发。日期：2026-09-24（中国时间）。本文件是技术验证交接，不是性能结论。权威运行规则见 [远程工作流](../REMOTE_EXPERIMENT_WORKFLOW.md)。
